...
interface ColorBendsProps extends React.HTMLAttributes<HTMLDivElement> {
  className?: string;
...
export default function ColorBends({
  ...
  return (
    <div ref={containerRef} className={`color-bends-container ${className}`.trim()} style={style} {...rest} />
  );
}
